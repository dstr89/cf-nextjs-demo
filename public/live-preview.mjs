...
function R(n, i, o) {
  ...
  $.log("Send message", s), o.forEach((a) => {
    var f;
...
vt.exports;
(function(n, i) {
  var o = 200, s = "__lodash_hash_undefined__", a = 1, f = 2, h = 9007199254740991, p = "[object Arguments]", l = "[object Array]", v = "[object AsyncFunction]", _ = "[object Boolean]", C = "[object Date]", L = "[object Error]", X = "[object Function]", B = "[object GeneratorFunction]", F = "[object Map]", Q = "[object Number]", rt = "[object Null]", W = "[object Object]", St = "[object Promise]", Ee = "[object Proxy]", Lt = "[object RegExp]", ot = "[object Set]", Nt = "[object String]", be = "[object Symbol]", me = "[object Undefined]", Et = "[object WeakMap]", jt = "[object ArrayBuffer]", st = "[object DataView]", ye = "[object Float32Array]", _e = "[object Float64Array]", Te = "[object Int8Array]", we = "[object Int16Array]", Oe = "[object Int32Array]", Ce = "[object Uint8Array]", Ie = "[object Uint8ClampedArray]", De = "[object Uint16Array]", Ae = "[object Uint32Array]", Se = /[\\^$.*+?()[\]{}|]/g, Le = /^\[object .+?Constructor\]$/, Ne = /^(?:0|[1-9]\d*)$/, E = {};
  E[ye] = E[_e] = E[Te] = E[we] = E[Oe] = E[Ce] = E[Ie] = E[De] = E[Ae] = !0, E[p] = E[l] = E[jt] = E[_] = E[st] = E[C] = E[L] = E[X] = E[F] = E[Q] = E[W] = E[Lt] = E[ot] = E[Nt] = E[Et] = !1;
  var Rt = typeof gt == "object" && gt && gt.Object === Object && gt, je = typeof self == "object" && self && self.Object === Object && self, U = Rt || je || Function("return this")(), Mt = i && !i.nodeType && i, Ut = Mt && !0 && n && !n.nodeType && n, zt = Ut && Ut.exports === Mt, bt = zt && Rt.process, Pt = function() {
    try {
  ...
  var Fe = Array.prototype, Ve = Function.prototype, at = Object.prototype, mt = U["__core-js_shared__"], Gt = Ve.toString, j = at.hasOwnProperty, kt = function() {
    var t = /[^.]+$/.exec(mt && mt.keys && mt.keys.IE_PROTO || "");
    return t ? "Symbol(src)_1." + t : "";
  }(), xt = at.toString, Ye = RegExp(
    "^" + Gt.call(j).replace(Se, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), $t = zt ? U.Buffer : void 0, ct = U.Symbol, Ft = U.Uint8Array, Vt = at.propertyIsEnumerable, He = Fe.splice, V = ct ? ct.toStringTag : void 0, Yt = Object.getOwnPropertySymbols, Je = $t ? $t.isBuffer : void 0, qe = xe(Object.keys, Object), yt = Z(U, "DataView"), tt = Z(U, "Map"), _t = Z(U, "Promise"), Tt = Z(U, "Set"), wt = Z(U, "WeakMap"), et = Z(Object, "create"), Ke = J(yt), We = J(tt), Ze = J(_t), Xe = J(Tt), Qe = J(wt), Ht = ct ? ct.prototype : void 0, Ot = Ht ? Ht.valueOf : void 0;
  function Y(t) {
  ...
  function rn(t) {
    var e = this.__data__;
    return et ? e[t] !== void 0 : j.call(e, t);
  }
  function on(t, e) {
    var r = this.__data__;
  ...
  function wn(t, e) {
    ...
    for (var m in t)
      (e || j.call(t, m)) && !(y && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function qt(t, e, r, c, b) {
    return t === e ? !0 : t == null || e == null || !it(t) && !it(e) ? t !== t && e !== e : Cn(t, e, r, c, qt, b);
  }
  function Cn(t, e, r, c, b, u) {
    var y = ft(t), T = ft(e), w = y ? l : k(t), m = T ? l : k(e);
    w = w == p ? W : w, m = m == p ? W : m;
    var I = w == W, N = m == W, O = w == m;
    if (O && Ct(t)) {
      if (!Ct(e))
        return !1;
      y = !0, I = !1;
    ...
    if (O && !I)
      return u || (u = new G()), y || ee(t) ? Kt(t, e, r, c, b, u) : Sn(t, e, w, r, c, b, u);
    if (!(r & a)) {
      var D = I && j.call(t, "__wrapped__"), A = N && j.call(e, "__wrapped__");
      if (D || A) {
        var x = D ? t.value() : t, P = A ? e.value() : e;
        return u || (u = new G()), b(x, P, r, c, u);
      }
    }
    return O ? (u || (u = new G()), Ln(t, e, r, c, b, u)) : !1;
  }
  function In(t) {
    if (!te(t) || Un(t))
      return !1;
  ...
  function An(t) {
    ...
    for (var r in Object(t))
      j.call(t, r) && r != "constructor" && e.push(r);
    return e;
  }
  function Kt(t, e, r, c, b, u) {
    ...
    for (u.set(t, e), u.set(e, t); ++I < T; ) {
      ...
      if (O) {
        if (!Ue(e, function(P, q) {
          if (!Be(O, q) && (D === P || b(D, P, r, c, u)))
            return O.push(q);
        })) {
          N = !1;
          break;
  ...
  function Sn(t, e, r, c, b, u, y) {
    switch (r) {
      ...
      case jt:
        return !(t.byteLength != e.byteLength || !u(new Ft(t), new Ft(e)));
      case _:
      case C:
      case Q:
        return Zt(+t, +e);
      ...
      case ot:
        var w = c & a;
        if (T || (T = $e), t.size != e.size && !w)
          return !1;
        var m = y.get(t);
        if (m)
          return m == e;
        c |= f, y.set(t, e);
        var I = Kt(T(t), T(e), c, b, u, y);
        return y.delete(t), I;
      case be:
        if (Ot)
  ...
  function Ln(t, e, r, c, b, u) {
    var y = r & a, T = Wt(t), w = T.length, m = Wt(e), I = m.length;
    if (w != I && !y)
      return !1;
    for (var N = w; N--; ) {
      var O = T[N];
      if (!(y ? O in e : j.call(e, O)))
        return !1;
    }
    var D = u.get(t);
    if (D && u.get(e))
    ...
    for (var x = y; ++N < w; ) {
      ...
      var P = t[O], q = e[O];
      if (c)
        var ne = y ? c(q, P, O, e, t, u) : c(P, q, O, t, e, u);
      if (!(ne === void 0 ? P === q || b(P, q, r, c, u) : ne)) {
        A = !1;
        break;
      }
      x || (x = O == "constructor");
  ...
  var jn = Yt ? function(t) {
    return t == null ? [] : (t = Object(t), Re(Yt(t), function(e) {
      return Vt.call(t, e);
    }));
  } : $n, k = nt;
  (yt && k(new yt(new ArrayBuffer(1))) != st || tt && k(new tt()) != F || _t && k(_t.resolve()) != St || Tt && k(new Tt()) != ot || wt && k(new wt()) != Et) && (k = function(t) {
    var e = nt(t), r = e == W ? t.constructor : void 0, c = r ? J(r) : "";
    if (c)
      switch (c) {
        case Ke:
          return st;
  ...
  var Bn = Jt(/* @__PURE__ */ function() {
    ...
    return it(t) && j.call(t, "callee") && !Vt.call(t, "callee");
  }, ft = Array.isArray;
  function Gn(t) {
...
var g = /* @__PURE__ */ ((n) => (n.FIELD_ID = "data-contentful-field-id", n.ENTRY_ID = "data-contentful-entry-id", n.ASSET_ID = "data-contentful-asset-id", n.LOCALE = "data-contentful-locale", n.SPACE = "data-contentful-space", n.ENVIRONMENT = "data-contentful-environment", n))(g || {}), K = /* @__PURE__ */ ((n) => (n.MOUSE_MOVE = "MOUSE_MOVE", n.SCROLL_START = "SCROLL_START", n.SCROLL_END = "SCROLL_END", n.RESIZE_START = "RESIZE_START", n.RESIZE_END = "RESIZE_END", n.TAGGED_ELEMENTS = "TAGGED_ELEMENTS", n.INSPECTOR_MODE_CHANGED = "INSPECTOR_MODE_CHANGED", n))(K || {}), fe = { 0: 8203, 1: 8204, 2: 8205, 3: 8290, 4: 8291, 5: 8288, 6: 65279, 7: 8289, 8: 119155, 9: 119156, a: 119157, b: 119158, c: 119159, d: 119160, e: 119161, f: 119162 }, he = { 0: 8203, 1: 8204, 2: 8205, 3: 65279 };
...
class mi {
  constructor(i) {
    d(this, "delay", 300), d(this, "isScrolling", !1), d(this, "scrollTimeout"), d(this, "isResizing", !1), d(this, "resizeTimeout"), d(this, "hoveredElement"), d(this, "taggedElements", []), d(this, "manuallyTaggedCount", 0), d(this, "automaticallyTaggedCount", 0), d(this, "intersectionObserver"), d(this, "observersCB", []), d(this, "cleanupCB", []), d(this, "init", () => {
      ...
      if (o.method === K.INSPECTOR_MODE_CHANGED) {
      ...
      const { targetOrigin: o } = this.options, s = () => {
        this.isScrolling || (this.isScrolling = !0, R(K.SCROLL_START, {}, o)), this.scrollTimeout && clearTimeout(this.scrollTimeout), this.scrollTimeout = setTimeout(() => {
          this.isScrolling = !1, R(K.SCROLL_END, {}, o), this.updateElements();
        }, this.delay);
      ...
      const { targetOrigin: o } = this.options, s = new ResizeObserver(() => {
        this.isResizing || (this.isResizing = !0, R(K.RESIZE_START, {}, o)), this.resizeTimeout && clearTimeout(this.resizeTimeout), this.resizeTimeout = setTimeout(() => {
          this.isResizing = !1, R(K.RESIZE_END, {}, o), this.updateElements();
        }, this.delay);
      });
...
const { parse: Si, stringify: yi } = JSON, _i = String, Ti = "string", se = "object", wi = (n, i) => i, ae = (n, i, o) => {
  ...
  function v(_, C) {
    if (l)
      return l = !l, C;
    const L = s.call(this, _, C);
    switch (typeof L) {
      case se:
        if (L === null)
          return L;
      case Ti:
        return a.get(L) || ae(a, f, L);
    }
    return L;
  }
};
...
class Di {
  constructor({ locale: i, targetOrigin: o }) {
    d(this, "subscriptions", /* @__PURE__ */ new Map()), d(this, "defaultLocale"), d(this, "sendMessage"), this.defaultLocale = i, this.sendMessage = (s, a) => R(s, a, o);
  }
  ...
  async receiveMessage(i) {
    if (i.method === M.ENTRY_UPDATED) {
      ...
      a ? (a.callback(o), a.data = o, this.subscriptions.set(s, a)) : $.error("Received an update for an unknown subscription", {
        subscriptionId: s,
        data: o,
...
const ce = [
  ...
  static init(i) {
    ...
    if (typeof window < "u") {
      ...
      if (s && oe(s), typeof a == "boolean" && (this.inspectorModeEnabled = a), typeof f == "boolean" && (this.liveUpdatesEnabled = f), this.locale = h, this.space = l, this.environment = p, this.initTargetOrigin(v), this.initialized)
        return $.log("You have already initialized the Live Preview SDK."), Promise.resolve(Dt.inspectorMode);
      this.inspectorModeEnabled && (this.inspectorMode = new mi({
        ...
        var F, Q, rt;
        if (ai(B)) {
          if ($.log("Received message", B.data), B.data.method === M.DEBUG_MODE_ENABLED) {
            oe(!0);
            return;
          }
          this.inspectorModeEnabled && ((F = this.inspectorMode) == null || F.receiveMessage(B.data)), this.liveUpdatesEnabled && ((Q = this.liveUpdates) == null || Q.receiveMessage(B.data), (rt = this.saveEvent) == null || rt.receiveMessage(B.data));
        }
      }), ei(() => {
        R(
          M.URL_CHANGED,
      ...
      const { taggedElements: _, manuallyTaggedCount: C, automaticallyTaggedCount: L } = this.inspectorModeEnabled ? At({
        options: {
          locale: this.locale,
          space: this.space,
          environment: this.environment
      ...
      return R(
        M.CONNECTED,
        {
          ...
          automaticallyTaggedElementCount: L
        },
        this.targetOrigin
  ...
  static getProps(i) {
    ...
    return $.warn("Missing property for inspector mode", { ...i }), null;
  }
  ...
  static openEntryInEditor(i) {
    ...
    $.error("Please provide field id and entry id to openEntryInEditor.");
  }
  /**
...
d(S, "initialized", !1), d(S, "inspectorMode", null), d(S, "liveUpdates", null), d(S, "saveEvent", null), d(S, "inspectorModeEnabled", !0), d(S, "liveUpdatesEnabled", !0), d(S, "locale"), d(S, "space"), d(S, "environment"), d(S, "sendMessage"), d(S, "targetOrigin");
let ve = S;
ve.init({
  locale: "en-US",
  debugMode: !0,
